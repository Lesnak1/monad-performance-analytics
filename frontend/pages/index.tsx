    ...
    <>
      ...
      <div className="min-h-screen relative overflow-hidden noise-overlay">
        ...
        <main className="relative z-10 container mx-auto px-6 py-12 space-y-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-glow">
              <span className="bg-gradient-to-r from-white via-monad-300 to-cyber-blue bg-clip-text text-transparent">
               ...
               Current TPS: <span className="text-cyber-blue font-semibold">{loading ? '...' : metrics?.tps || 0}</span> with 
           ...
           <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             <StatCard
               title="Current TPS"
               value={loading ? "..." : metrics?.tps.toLocaleString() || "0"}
             ...
             <StatCard
               title="Gas Price"
               value={loading ? "..." : `${metrics?.gasPrice || '0'} MON`}
          ...
          {/* Live Transactions & Recent Test Results */}
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Live Transactions */}
            {mounted ? (
              <LiveTransactions networkConnected={networkStatus.connected} />
            ) : (
